...
?>
        <!-- breadcrumbs wrapper -->
        <div class="tempo-breadcrumbs p404 <?php echo esc_attr( $nav ); ?>">
                    ...
                    <div <?php echo tempo_content_class(); ?>>
                        <div <?php echo tempo_row_class(); ?>>
                            ...
                            <div <?php echo tempo_full_class(); ?>>
                                ...
                                <!-- headline / end -->
                                <h1 id="tempo-headline-404" class="tempo-headline"><?php printf( esc_html__( 'Error %1$s' , 'tempo' ) , number_format_i18n( 404 ) ); ?></h1>
