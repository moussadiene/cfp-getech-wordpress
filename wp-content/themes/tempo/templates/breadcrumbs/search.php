...
?>
        <!-- breadcrumbs wrapper -->
        <div class="tempo-breadcrumbs search <?php echo esc_attr( $nav ); ?>">
                    ...
                    <div <?php echo tempo_content_class(); ?>>
                        <div <?php echo tempo_row_class(); ?>>
                            ...
                            <div <?php echo tempo_large_class(); ?>>
                                ...
                                <!-- headline / end -->
                                <h1 id="tempo-headline-search" class="tempo-headline"><?php printf( esc_html__( 'Search results for "%1$s"', 'tempo' ), get_search_query() ); ?></h1>
